...
Located in `01_Python_OOP_Recap/3.Subscription Tracker - Inheritance and Status`

Project: Subscription Tracker CLI — an interactive command-line application that tracks physical and digital subscriptions, calculates dynamic annual costs, and allows users to safely cancel subscriptions using protected state variables to see real-time savings.
